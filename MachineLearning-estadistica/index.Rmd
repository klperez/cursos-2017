...
```{r randomData,fig.height=4,fig.width=6, fig.align='center'}
...
```{r dependson ="onePattern",fig.height=4,fig.width=6, fig.align='center'}
par(mar = rep(0.2,4))
image(1:10,1:40,t(dataMatrix)[,nrow(dataMatrix):1])
```
...
```{r dependson ="onePattern",fig.height=6,fig.width=6, fig.align='center'}
par(mar = rep(0.2,4))
heatmap(dataMatrix)
```
...
```{r oChunk, dependson ="onePattern",fig.height=4,fig.width=12, fig.align='center'}
...
```{r dependson ="oChunk",fig.height=4,fig.width=12, fig.align='center'}
...
```{r dependson ="oChunk",fig.height=5, fig.width=10, fig.align='center'}
par(mfrow = c(1,2))
...
```{r dependson ="oChunk",fig.height=5,fig.width=5, fig.align='center'}
svd1 <- svd(scale(dataMatrixOrdered))
...
```{r dependson ="oChunk",fig.height=4,fig.width=12,tidy=FALSE, fig.align='center'}
...
```{r twoPattern, dependson ="randomData",fig.height=4,fig.width=3, fig.align='center'}
set.seed(678910)
for(i in 1:40){
  # flip a coin
...
```{r  dependson ="twoPattern",fig.height=4.5,fig.width=12, fig.align='center'}
...
```{r,dependson="twoPattern",fig.height=4,fig.width=8,tidy=FALSE, fig.align='center'}
...
```{r loadFaceData ,fig.height=6,fig.width=6, fig.align='center'}
load("data/face.rda")
...
```{r,dependson="loadFaceData",fig.height=5,fig.width=6, fig.align='center'}
...
```{r dependson="approximations",fig.height=4,fig.width=12, fig.align='center'}
par(mfrow=c(1,4))
...
```{r createData, fig.height=3.5,fig.width=3.5, fig.align='center'}
...
```{r,dependson="createData",echo=FALSE,fig.height=5,fig.width=5, fig.align='center'}
par(mar=rep(0.2,4))
plot(x,y,col="blue",pch=19,cex=2)
text(x+0.05,y+0.05,labels=as.character(1:12))
cx <- c(1,1.8,2.5)
...
```{r, dependson="kmeans",fig.height=4,fig.width=4, fig.align='center'}
par(mar=rep(0.2,4))
...
```{r, dependson="kmeans",fig.height=4,fig.width=8, fig.align='center'}
set.seed(1234)
...
```{r dependson="createData",echo=FALSE, fig.height=5,fig.width=12, fig.align='center'}
library(fields)
dataFrame <- data.frame(x=x,y=y)
rdistxy <- rdist(dataFrame)
diag(rdistxy) <- diag(rdistxy) + 1e5
...
```{r, dependson="createData", fig.height=4,fig.width=6, fig.align='center'}
dataFrame <- data.frame(x=x,y=y)
distxy <- dist(dataFrame)
...
```{r, dependson="createData", fig.height=4,fig.width=4, fig.align='center'}
dataFrame <- data.frame(x=x,y=y)
distxy <- dist(dataFrame)
hClustering <- hclust(distxy)
